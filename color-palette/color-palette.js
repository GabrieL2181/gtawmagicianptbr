(function($) {
    ...
    function toggleColoringMode() {
        ...
        if (coloringMode) {
            ...
            alert("Clique no texto para selecioná-lo. Use Ctrl+clique para seleções múltiplas ou arraste para selecionar vários itens. Clique no botão 'Colorir Texto' novamente para sair do modo de coloração.");
    ...
    function showColorAppliedFeedback(colorClass) {
        ...
        const feedback = $(`<div class="color-applied-feedback">Aplicado ${colorClass}</div>`);
